...
export function AppHeader({
  ...
  return <View style={styles.header}>
    ...
    </Pressable> : <View style={styles.headerLeftSlot}>
      {showBack && <Pressable onPress={goBack} accessibilityRole="button" accessibilityLabel={language === 'ar' ? 'رجوع' : 'Go back'} testID="mobile-header-back" style={styles.headerBackButton}>
        <Feather name="arrow-left" size={19} color={colors.foreground} />
      </Pressable>}
    </View>}
    {!showBrand && (title || eyebrow) && <View pointerEvents="none" style={styles.headerTitleCentered}>
...
export const styles = StyleSheet.create({
  ...
  header: { minHeight: 56, position: 'relative', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 18, paddingBottom: 14 },
  ...
  logo: { fontFamily: fonts.bold, fontSize: 19, fontWeight: '800', letterSpacing: -0.7 },
  logoSub: { fontFamily: fonts.bold, fontSize: 7, fontWeight: '700', letterSpacing: 1.1, marginTop: 1 },
  headerRight: { flexDirection: 'row', alignItems: 'center', gap: 10 },
  headerLeftSlot: { width: 42, height: 42, alignItems: 'flex-start', justifyContent: 'center', zIndex: 2 },
  headerBackButton: { width: 42, height: 42, alignItems: 'center', justifyContent: 'center' },
  headerTitleCentered: { position: 'absolute', left: 58, right: 58, top: 0, bottom: 14, alignItems: 'center', justifyContent: 'center', zIndex: 1 },
  headerEyebrow: { fontFamily: fonts.bold, fontSize: 8, fontWeight: '800', letterSpacing: 1.1, textAlign: 'center' },
  headerText: { fontFamily: fonts.bold, fontSize: 18, fontWeight: '800', letterSpacing: -0.35, marginTop: 2, textAlign: 'center' },
  iconButton: { width: 42, height: 42, borderRadius: 21, alignItems: 'center', justifyContent: 'center', zIndex: 2 },
  ...
  productName: { fontFamily: fonts.bold, fontSize: 14, fontWeight: '800', lineHeight: 18 },
  productVenue: { fontFamily: fonts.regular, fontSize: 10, marginTop: 4 },
  productPrice: { fontFamily: fonts.bold, fontSize: 13, fontWeight: '800', marginTop: 12 },
  unit: { fontFamily: fonts.medium, fontSize: 9, fontWeight: '500' },
  ...
  addCount: { fontFamily: fonts.bold, fontSize: 11, fontWeight: '800' },
  ...
  venueInitial: { fontFamily: fonts.bold, fontSize: 52, fontWeight: '800', opacity: 0.9 },
  rating: { position: 'absolute', left: 11, top: 11, paddingHorizontal: 8, paddingVertical: 5, borderRadius: 13 },
  ratingText: { fontFamily: fonts.bold, fontSize: 10, fontWeight: '800' },
  venueCopy: { padding: 13 },
  venueName: { fontFamily: fonts.bold, fontSize: 15, fontWeight: '800' },
  venueMeta: { fontFamily: fonts.regular, fontSize: 10, marginTop: 9 },
  sectionTitle: { flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'space-between', marginTop: 27, marginBottom: 13 },
  eyebrow: { fontFamily: fonts.bold, fontSize: 9, fontWeight: '800', letterSpacing: 1.5, textTransform: 'uppercase' },
  sectionHeading: { fontFamily: fonts.bold, fontSize: 24, fontWeight: '800', letterSpacing: -0.7, marginTop: 5 },
  actionText: { fontFamily: fonts.bold, fontSize: 12, fontWeight: '800', paddingBottom: 3 },
  ...
  heroKicker: { fontFamily: fonts.bold, fontSize: 9, fontWeight: '800', letterSpacing: 1.5 },
  heroTitle: { fontFamily: fonts.bold, fontSize: 31, fontWeight: '800', letterSpacing: -1.2, marginTop: 9, lineHeight: 35 },
  heroBody: { fontFamily: fonts.regular, fontSize: 13, lineHeight: 19, marginTop: 11, maxWidth: 220 },
  ...
  heroButtonText: { fontFamily: fonts.bold, fontSize: 12, fontWeight: '800' },
  ...
  categoryText: { fontFamily: fonts.bold, fontSize: 11, fontWeight: '800' },
  ...
  promiseTitle: { fontFamily: fonts.bold, fontSize: 14, fontWeight: '800' },
  promiseBody: { fontFamily: fonts.regular, fontSize: 11, lineHeight: 17, marginTop: 4 },
  mobileEmpty: { flex: 1, alignItems: 'center', justifyContent: 'center', paddingVertical: 120 },
  mobileEmptyTitle: { fontFamily: fonts.bold, fontSize: 24, fontWeight: '800', marginTop: 15, marginBottom: 22 },
  ...
  primaryButtonText: { fontFamily: fonts.bold, fontSize: 14, fontWeight: '800' },
  backLink: { flexDirection: 'row', alignItems: 'center', gap: 7, marginBottom: 13, paddingVertical: 4 },
  backText: { fontFamily: fonts.bold, fontSize: 12, fontWeight: '800' },
  ...
  categoryTag: { fontFamily: fonts.bold, paddingHorizontal: 10, paddingVertical: 6, borderRadius: 12, fontSize: 9, fontWeight: '800', letterSpacing: 1 },
  basketTag: { fontFamily: fonts.bold, paddingHorizontal: 10, paddingVertical: 6, borderRadius: 12, fontSize: 10, fontWeight: '800' },
  detailTitle: { fontFamily: fonts.bold, fontSize: 29, lineHeight: 33, fontWeight: '800', letterSpacing: -0.8, marginTop: 17 },
  detailDescription: { fontFamily: fonts.regular, fontSize: 14, lineHeight: 21, marginTop: 10 },
  ...
  metaLabel: { fontFamily: fonts.bold, fontSize: 9, fontWeight: '800', letterSpacing: 1.1 },
  metaValue: { fontFamily: fonts.bold, fontSize: 12, fontWeight: '800', marginTop: 3 },
  priceRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 20 },
  detailPrice: { fontFamily: fonts.bold, fontSize: 25, fontWeight: '800', letterSpacing: -0.5 },
  ...
  quantityText: { fontFamily: fonts.bold, fontSize: 14, fontWeight: '800', minWidth: 13, textAlign: 'center' },
  ...
  secondaryButtonText: { fontFamily: fonts.bold, fontSize: 13, fontWeight: '800' },
  relatedGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 10 },
  shopIntro: { marginTop: 24, marginBottom: 13 },
  shopTitle: { fontFamily: fonts.bold, fontSize: 23, fontWeight: '800', letterSpacing: -0.5 },
  shopSubtitle: { fontFamily: fonts.regular, fontSize: 12, marginTop: 5 },
  emptyBody: { fontFamily: fonts.regular, fontSize: 13, lineHeight: 20, textAlign: 'center' },
  addressRow: { flexDirection: 'row', alignItems: 'center', gap: 9, borderWidth: 1, borderRadius: 17, padding: 14, marginBottom: 15 },
  addressText: { flex: 1, fontFamily: fonts.bold, fontSize: 12, fontWeight: '700' },
  changeText: { fontFamily: fonts.bold, fontSize: 11, fontWeight: '800' },
  cartList: { gap: 10 },
  ...
  cartName: { fontFamily: fonts.bold, fontSize: 13, lineHeight: 17, fontWeight: '800' },
  ...
  summaryValue: { fontFamily: fonts.bold, fontSize: 12, fontWeight: '700' },
  summaryTotal: { borderTopWidth: 1, paddingTop: 14, marginTop: 3 },
  summaryTotalLabel: { fontFamily: fonts.bold, fontSize: 15, fontWeight: '800' },
  summaryTotalValue: { fontFamily: fonts.bold, fontSize: 18, fontWeight: '800' },
  ...
  segmentText: { fontFamily: fonts.bold, fontSize: 11, fontWeight: '800' },
  orderCard: { borderWidth: 1, borderRadius: 24, padding: 17 },
  orderHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start' },
  orderHeading: { flex: 1 },
  statusPill: { fontFamily: fonts.bold, alignSelf: 'flex-start', paddingHorizontal: 9, paddingVertical: 6, borderRadius: 11, fontSize: 9, fontWeight: '800', letterSpacing: 0.7 },
  orderName: { fontFamily: fonts.bold, fontSize: 14, fontWeight: '800' },
  orderId: { fontFamily: fonts.regular, fontSize: 10, marginTop: 4 },
  ...
  timelineText: { fontFamily: fonts.regular, fontSize: 9, textAlign: 'center' },
  courier: { flexDirection: 'row', alignItems: 'center', borderRadius: 16, padding: 11 },
  avatar: { width: 34, height: 34, borderRadius: 17, alignItems: 'center', justifyContent: 'center' },
  avatarText: { fontFamily: fonts.bold, fontSize: 14, fontWeight: '800' },
  courierCopy: { flex: 1, marginLeft: 10 },
  courierTitle: { fontFamily: fonts.bold, fontSize: 11, fontWeight: '800' },
  courierBody: { fontFamily: fonts.regular, fontSize: 10, marginTop: 3 },
  etaBox: { borderRadius: 20, padding: 17, marginTop: 14 },
  etaLabel: { fontFamily: fonts.bold, fontSize: 9, fontWeight: '800', letterSpacing: 1.1 },
  eta: { fontFamily: fonts.bold, fontSize: 30, fontWeight: '800', marginTop: 7 },
  etaSub: { fontFamily: fonts.regular, fontSize: 11, marginTop: 2 },
  totalRow: { fontFamily: fonts.regular, fontSize: 11, marginTop: 18 },
  pastList: { gap: 10 },
  ...
  pastCopy: { flex: 1 },
  pastTotal: { fontFamily: fonts.bold, fontSize: 11, fontWeight: '800' },
  ...
  profileAvatarText: { fontFamily: fonts.bold, fontSize: 24, fontWeight: '800' },
  profileCopy: { flex: 1, marginLeft: 13 },
  profileName: { fontFamily: fonts.bold, fontSize: 17, fontWeight: '800' },
  profilePhone: { fontFamily: fonts.regular, fontSize: 11, marginTop: 4 },
  ...
  accountTitle: { fontFamily: fonts.bold, fontSize: 12, fontWeight: '800' },
  accountDetail: { fontFamily: fonts.regular, fontSize: 10, marginTop: 4 },
